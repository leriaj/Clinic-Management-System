...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['patient_id'])) {
    ...
    if ($stmt->execute()) {
        echo "<script>alert('Updating patient profile is successful!'); window.location.href = 'ddpatientslist.php';</script>";
    } else {
            ...
            <div class="c1">
                ...
                <div class="overlay" id="overlay">
                    <div class="overlay-content">
                        ...
                        <form method="get" action="pprof.php" id="search-form">
                ...
                <form method="post" action="pprof.php?patient_id=<?php echo $patient_id; ?>">
